...
export default function FooterTop() {
    return (
        <section className='container-fluid bg-green-lighter pt-12 pb-12'>
            <div className='container'>
                <div className='row well items-center'>
                    <div className="col-lg-4 col-md-12 col-sm-12 mb-sm-20 mb-xs-20">
                        {/* --=======  newsletter title =======-- */}
                        <div className="newsletter-title">
                            <h1 className='flex whitespace-nowrap text-white font-halal items-center sm:text-xl'>
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 mb-sm-20 mb-xs-20"> 
                        ...
                        <p className="mb-xs-20 w-1/3 sm:w-full font-halal realtive font-thin text-white text-sm tracking-wide pr-1">Sign up for our newsletter to receive updates and Exclusive offers</p>
                        <div className="mb-xs-20 sm:w-full header-advance-search w-2/3">
