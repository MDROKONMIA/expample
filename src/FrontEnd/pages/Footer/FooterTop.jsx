            ...
            <div className='container'>
                <div className='row well items-center'>
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 mb-sm-20 mb-xs-20"> 
                        ...
                        <p className="mb-xs-20 w-1/3 font-halal realtive font-thin text-white text-sm tracking-wide pr-1">Sign up for our newsletter to receive updates and Exclusive offers</p>
